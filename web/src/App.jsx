    ...
    <header className="bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center space-x-4">
          ...
          {payload && payload.roles && Array.isArray(payload.roles) && payload.roles.includes('ROLE_STAFF') && (
            <Link to="/applications" className="text-sm text-slate-700">Applications</Link>
          )}
          <ProfileMenu />
        </nav>
      </div>
